    ...
    <Container className="policy">
      ...
      <ul>
        <li>
          ...
          about cookies, and how to disable cookies, visit span
      ...
      <Typography variant="body2">
        ...
        Abjari to power our online store--you can read more about how Shopify
      ...
      <Typography variant="h6">BEHAVIOURAL ADVERTISING</Typography>
      <Typography variant="body2">
      ...
      <Typography variant="body2">
        ...
        support@abjari.com or by mail using the details provided below:
        Mitskevichi street 14, Tbilisi, 0194, Georgia
      </Typography>
      <Typography variant="h6">OVERVIEW</Typography>
      <Typography variant="body2">
        This website is operated by Abjari. Throughout the site, the terms “we”,
        “us” and “our” refer to Abjari. Abjari offers this website, including
      ...
      <Typography variant="h6">SECTION 7 - OPTIONAL TOOLS</Typography>
      <Typography variant="body2">
      ...
      <Typography variant="h6">SECTION 8 - THIRD-PARTY LINKS</Typography>
      <Typography variant="body2">
      ...
      <Typography variant="h6">SECTION 10 - PERSONAL INFORMATION</Typography>
      <Typography variant="body2">
      ...
      <Typography variant="h6">SECTION 12 - PROHIBITED USES</Typography>
      <Typography variant="body2">
      ...
      <Typography variant="body2">
        ...
        non-infringement.
        <Typography variant="body2">
          In no case shall Abjari, our directors, officers, employees,
      ...
      <Typography variant="h6">SECTION 14 - INDEMNIFICATION</Typography>
      <Typography variant="body2">
        You agree to indemnify, defend and hold harmless Abjari and our parent,
      ...
      <Typography variant="h6">SECTION 15 - SEVERABILITY</Typography>
      <Typography variant="body2">
      ...
      <Typography variant="h6">SECTION 16 - TERMINATION</Typography>
      <Typography variant="body2">
      ...
      <Typography variant="h6">SECTION 17 - ENTIRE AGREEMENT</Typography>
      <Typography variant="body2">
      ...
      <Typography variant="h6">SECTION 18 - GOVERNING LAW</Typography>
      <Typography variant="body2">
      ...
      <Typography variant="h6">SECTION 20 - CONTACT INFORMATION</Typography>
      <Typography variant="body2">
        Questions about the Terms of Service should be sent to us at
        <a href="mailto:support@abjari.com">support@abjari.com</a>
      </Typography>
    </Container>
  );
};
